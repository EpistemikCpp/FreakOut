...
//#define THOMAS //*/ MARIE_LAURE
    ...
    char *BALL_BITMAP = "happy_bitmap2.bmp" ;
    int PADDLE_WIDTH      =  96 ,	  
        PADDLE_THICKNESS  =  10 ,		
    // ball parameters
        //BALL_SIZE         =  15 ,	 
    ...
    char *GAME_STRING = "Thomas Rainbow!" ;
    char *BALL_BITMAP = "happy_bitmap4.bmp" ;
    int PADDLE_WIDTH      =  50 ,	   
        PADDLE_THICKNESS  =   7 ,		
    // ball parameters
        //BALL_SIZE         =   9 ,	 
    ...
    /* THIS WAS THE ONLY WAY TO USE A DIFFERENT STRING FOR DIFFERENT VERSIONS
       -> strcat() DID NOT WORK! */
    char *BALL_BITMAP = "happy_bitmap3.bmp" ;
    int PADDLE_WIDTH      =  48 ,	  
        PADDLE_THICKNESS  =   8 ,		
    // ball parameters
...
void Freak::Game_Init( HWND hwnd )
{
	// initialize graphics
   bb.DD_Init( hwnd, BALL_BITMAP, SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN_BPP );
